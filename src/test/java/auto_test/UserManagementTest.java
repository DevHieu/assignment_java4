...
public class UserManagementTest extends BaseTest {
    ...
    public void testAddUserValid() {
        ...
        driver.findElement(By.cssSelector("#userModal button[type='submit']")).click();

        Assert.assertTrue(driver.getPageSource().contains("Thêm người dùng thành công"));
    }
    ...
    public void testUpdateUserChangePassword() {
        ...
        driver.findElement(By.name("password")).sendKeys("admin123");
        driver.findElement(By.name("confirmPassword")).sendKeys("new123");
