					...
					<div class="row">
						<div class="col-lg-8">
							<div class="ratio ratio-16x9 mb-4 bg-dark rounded">
								<iframe class="w-100 h-100 rounded-2"
							...
							<div class="video-info mb-4">
								...
								<div
									...
									<div class="text-muted">
										<span class="me-3"><i class="fas fa-eye me-1"></i>
											${video.views } lượt xem</span>
									...
									<div class="d-flex gap-2">
										<button
											...
											data-is-liked="${isLiked}" id="like-btn-${video.id}">
											<i class="${isLiked ? 'fas' : 'far'} fa-heart me-1"></i> <span>${isLiked ? 'Đã thích' : 'Thích'}</span>
										</button>

										<button class="btn btn-sm icon-btn z-3" data-bs-toggle="modal"
											data-bs-target="#share" data-video-id="${video.id}">
								...
								<core:forEach var="list" items="${ListVideoAll}">
									...
									<div class="suggested-video-item d-flex gap-2 mb-3">
										<div class="flex-shrink-0">
											<img src="https://img.youtube.com/vi/${list.id}/maxresdefault.jpg"
												alt="Video Thumbnail for ${list.title}" class="rounded"
												width="120" height="68" />
										</div>
    ...
    function likeVideo(videoId, button) {
        ...
        .catch((error) => {
            ...
            if (error.message.includes("Vui lòng đăng nhập")) {
                ...
                alert("Không thể kết nối đến máy chủ hoặc lỗi không xác định: " + error.message);
            }
        })
        .finally(() => {
