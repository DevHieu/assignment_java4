        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-primary shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div id="totalVideo" class="h5 mb-0 fw-bold">${totalVideo}</div>
                </div>z
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div id="totalUser" class="h5 mb-0 fw-bold">${totalUser}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-danger shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div id="totalLike" class="h5 mb-0 fw-bold">${totalLike}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-warning shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div id="totalShare" class="h5 mb-0 fw-bold">${totalShare}</div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <table id="top10Table" class="table table-hover table-sm">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>Tiêu đề</th>
                        ...
                        <c:forEach var="video" items="${top10Videos}" varStatus="st">
                            <tr>
                                <td>${st.count}</td>
                                <td>${video.title}</td>
                                <td class="like-count">${video.totalLike}</td>
                                <td>${video.views}</td>
                                <td>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <table id="bannerTable" class="table table-bordered table-sm text-center">
                        <thead>
                        <tr>
                            <th>Id</th>
                            <th>Tiêu đề</th>
