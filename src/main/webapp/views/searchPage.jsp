              ...
              <div class="container">
                <div class="row align-items-center">
                  <div class="col-md-6">
                    ...
                    <p class="text-muted mb-0">Tìm được ${listVideoSearchList.size()} video liên quan</p>
                  </div>
                  <div class="col-md-6">
                  ...
                  <core:forEach var="list" items="${listVideoSearchList}">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                      <div class="card video-card h-100 bg-dark">
                        <img src="<c:url value='/images/baner1.png' />" class="card-img-top" alt="Video Thumbnail" />
                          ...
                          <div class="d-flex justify-content-between align-items-center mt-auto">
                            <div class="d-flex gap-3 text-muted small">
                              ...
                              <span class="like-btn" style="cursor: pointer">
                                ...
                                <span class="like-count"><a href="http://localhost:8080/ASM-J4/views/sreachPage.jsp"
                                    class="text-decoration-none text-reset">${list[1]}</a></span>
                              </span>

                              <span class="like-btn" style="cursor: pointer">
                                <i class="fa-solid fa-share"></i>
                                <span class="like-count"><a href="#"
                                    class="text-decoration-none text-reset">${list[2]}</a></span>
                              </span>
                            </div>
