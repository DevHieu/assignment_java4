    ...
    <main class="container-fluid py-5">
        <div class="container-lg">
            ...
            <div class="d-flex gap-2 mb-4">
                <button id="filter-liked" class="btn btn-outline-primary active">Đã thích</button>
                <button id="filter-all" class="btn btn-outline-primary">Tất cả</button>
            </div>
            ...
            <div class="row g-4" id="video-grid">
                ...
                <div class="col-md-3">
                    <div class="card border-0 h-100">
                        <div class="card-body p-0">
                            <img src="../images/baner1.png" class="w-100"
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex gap-2">
                                    <button class="btn btn-sm btn-outline-primary"><i class="fas fa-thumbs-up"></i></button>
                ...
                <div class="col-md-3">
                    <div class="card border-0 h-100">
                        <div class="card-body p-0">
                            <img src="../images/baner2.jpg" class="w-100"
                                 style="aspect-ratio:16/9;object-fit:cover;border-radius:0.375rem 0.375rem 0 0;">
                            <div class="p-3">
                ...
                <div class="col-md-3">
                    <div class="card border-0 h-100">
                        <div class="card-body p-0">
                            <img src="../images/baner3.jpg" class="w-100"
                                 style="aspect-ratio:16/9;object-fit:cover;border-radius:0.375rem 0.375rem 0 0;">
                            <div class="p-3">
