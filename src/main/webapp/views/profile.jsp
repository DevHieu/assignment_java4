...
<div class="container-lg d-flex align-items-center justify-content-center mt-4 p-4">
        ...
        <aside class="col-md-3 col-lg-3 p-0 sidebar-nav-container">
            <nav class="h-100 p-2">
                <div class="d-flex flex-column gap-1">
                    ...
                    >
                        <i class="fa-solid fa-user me-2"></i> Thông tin Hồ Sơ
                    </button>
        ...
        <main class="col-md-9 col-lg-9 p-0">
            <div class="h-100 main-content-panel">
                ...
                <section id="profile-section">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <img
                                            ...
                                            alt="avatar preview">
                                    <span id="avatar-text" class="small">No Avatar</span>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    ...
                    <form action="profile" method="POST" id="form-update-profile">
                ...
                <section id="password-section" class="d-none">
                    ...
                    <form action="profile" method="POST" id="form-change-password" onsubmit="return validatePasswordChange(event)">
